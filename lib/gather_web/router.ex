defmodule GatherWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {GatherWeb.Layouts, :root}
  ...
  if Application.compile_env(:gather, :dev_routes) do
  ...
  scope "/", GatherWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{GatherWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", GatherWeb do
    ...
    live_session :current_user,
      on_mount: [{GatherWeb.UserAuth, :mount_current_user}] do
